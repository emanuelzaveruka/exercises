...
<?php  require_once("header.php");?>
    ...
    <form action="db/edit_tarefa.php" method="post">
        <input type="hidden" value="<?php echo $tarefa["cod"];?>" name="cod">
        Título:   
        ...
        Categoria:
        <select name="categoria" value="categoria" style="display: flex;">
        <?php 
        ...
        Descrição: 
        <textarea name="descricao" id="" cols="30" rows="10" value="<?php echo $tarefa['descricao']?>">  </textarea> <br>
